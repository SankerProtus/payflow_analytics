...
dashboardRoutes.get("/customer-activity", dashboardController.getCustomerActivity);
dashboardRoutes.get("/dunning-overview", dashboardController.getDunningOverview);
dashboardRoutes.get("/subscription-stats", dashboardController.getSubscriptionStats);
dashboardRoutes.get("/churn-analysis", dashboardController.getChurnAnalysis);
dashboardRoutes.get("/payment-failures", dashboardController.getPaymentFailures);
...
dashboardRoutes.get("/financial-reports", dashboardController.getFinancialReports);
...
dashboardRoutes.get("/notifications", dashboardController.getDashboardNotifications);
dashboardRoutes.post("/notifications/mark-read", dashboardController.markNotificationsRead);
